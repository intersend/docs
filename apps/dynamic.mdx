...
- Your existing web app is powered by Dynamic (dynamic.xyz) for authentication and embedded wallet management.
...
For Dynamic v3:
```bash
npm install @dynamic-labs-connectors/intersend-evm@3.1.1
# or
yarn add @dynamic-labs-connectors/intersend-evm@3.1.1
```
