...
description: 'Learn how to integrate your Privy-powered app with Intersend.'
slug: '/privy'
---
...
<Accordion title="intersend-connector.js">
```ts /intersend-connector.js
/**
...
<Accordion title="useIntersendAutoConnect.js">
```ts /hooks/useIntersendAutoConnect.js
