...
description: 'Add Intersend Wallet to your RainbowKit configuration for seamless wallet integration.'
---
...
- Ensure that Polygon is included in the "chains". If Polygon is not accepted, please contact [arda@intersend.io](mailto:arda@intersend.io) for further details about how to add custom authentication within RainbowKit. However, please note that Intersend supports transactions on any chain, not just Polygon.
...
export const IntersendWallet = ({ projectId }: IntersendWalletOptions): Wallet => ({
  id: 'intersend',
  name: 'Intersend',
  iconUrl: 'https://intersend-content-s3-bucket.s3.us-east-1.amazonaws.com/intersend-icon.png',
  iconBackground: '#6b8cfe',
  downloadUrls: {
    qrCode: 'https://intersend-content-s3.amazonaws.com/styled_qr_with_logo.png',
  },
  mobile: {
    getUri: (uri: string) => {
  ...
  qrCode: {
    ...
    instructions: {
      learnMoreUrl: 'https://intersend-wallet/learn-more',
      steps: [
        {
...
```typescript
import { IntersendWallet } from './wallet/intersend-wallet';
...
After this step, please reach out to us at [arda@intersend.io](mailto:arda@intersend.io) to get your app listed on InterSpace.

### Conclusion

By following these steps, you can integrate the Intersend Wallet with your RainbowKit configuration, providing a seamless wallet experience for your users. If you encounter any issues or have further questions, please contact [arda@intersend.io](mailto:arda@intersend.io).
