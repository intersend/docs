...
- Ensure that Polygon is included in the "chains" in your wagmi.ts. If Polygon is not accepted, please contact [arda@intersend.io](mailto:arda@intersend.io) for further details about how to add custom authentication within RainbowKit. However, please note that Intersend supports transactions on any chain, not just Polygon.
